/**
 * JavascriptHinter - eslint_d connector
 *
 * Runs the installed eslint_d version with the default JSON reporter and parses
...
/**
 * JavaScriptHinter for TextMate plugin for eslint_d.
...
module.exports = {
  ...
  name: 'eslint_d',
  /**
   * Process the file using eslint_d.
  ...
  process: function(files, options) {
    ...
    let originalOutput = getJsonOutput('eslint_d', args, {cwd: cwd});
